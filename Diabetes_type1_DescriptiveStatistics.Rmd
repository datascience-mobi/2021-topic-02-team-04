...
ctrl_high_var <- cbind(high_var_diabetes_ctrl_median["CUZD1",], high_var_diabetes_ctrl_median["GP2",],
                       high_var_diabetes_ctrl_median["PNLIPRP1",], 
                       high_var_diabetes_ctrl_median["PNLIP",])

treat_high_var <- cbind(high_var_diabetes_treat_median["CUZD1",], high_var_diabetes_treat_median["GP2",],
                        high_var_diabetes_treat_median["PNLIPRP1",], high_var_diabetes_treat_median["PNLIP",])
