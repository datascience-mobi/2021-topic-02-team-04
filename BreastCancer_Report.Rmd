...
meanbreast2 <- median(breast_GeneExprs_sub_combined)

length(which(apply(breast_GeneExprs_sub_combined,1,median) > meanbreast2))

# 124 genes have a higher expression than the overall median

#Creating matrix with overexpressed TRAs in decreasing order

overexpressedbreast <- breast_GeneExprs_sub_combined[which(apply(breast_GeneExprs_sub_combined,1,median)> meanbreast2),]
