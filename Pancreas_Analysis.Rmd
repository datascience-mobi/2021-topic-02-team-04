...
autoplot(pancreas_GeneExprs_sub_combined[c("CHST4", "PABPC4", "ECI2", "TMEM97", "ANXA4", "NEURL3", "MKNK1", "MED24"),], xlab = "Microarrays", ylab = "Genes")
```
...
fc = log2.fold.change(pancreas_ctrl, pancreas_treat)
filter(fc, abs(log2_foldchange) > 0.15)

ggplot(data = fc, aes(x = log2_foldchange, y = ttest_log10_pvalue, label = GeneSymbol)) + 
  geom_point() + 
