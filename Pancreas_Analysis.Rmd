...
dim(combineGeneExprs(all_TRA_GeneExprs))
```
...
pheatmap(pancreas_GeneExprs[which(rownames(pancreas_GeneExprs) == "TBL1X"),], 
         ...
         main = "Heatmap of TBL1X gene expression in pancreatic cancer cells \n data set: GSE59761",
         cluster_rows = TRUE, treeheight_row = 0)

setwd(paste(projectPath, "plots", sep = "/"))
dev.copy2pdf(file = "pancreas_analysis_heatmap_TBL1X.pdf")
...
setwd(paste(projectPath, "plots", sep = "/"))
dev.copy2pdf(file = "pancreas_analysis_heatmap_allTRAs.pdf")
```
