...
par(las=2)
par(mai = c(0.9,0.4,0.6,0.1))

boxplot(data_pancreas, names = pancreas_samples, col = rainbow(6), main = "microarray gene expression of PDAC data set (GSE59761) \n before normalization", cex.axis=0.6)
...
boxplot(data_pancreas, names = pancreas_samples, col = rainbow(6), main = "microarray gene expression of PDAC data set (GSE59761) \n after normalization", cex.axis=0.6)
...
hist(data_pancreas, col = rainbow(6), main = "Density function of log intensity of PDAC cells (GSE59761) \n before normalization")
...
par(mai = c(0.9,0.9,0.6,0.1))
plot(density(pancreas_vsnrma_matrix[,1]), type = "n", xlab = "log intensity", main = "Density function of log intensity of PDAC cells (GSE59761) \n after normalization", ylim = c(0,0.4))
...
setwd(paste(projectPath, "plots" ,sep = "/"))
dev.copy2pdf(file = "PDAC data set (GSE59761) rawdata")
