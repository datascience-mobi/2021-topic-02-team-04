...
hist(data_pancreas, col = rainbow(6), main = "Density function of log intensity of PDAC cells (GSE53454) \n before normalization")
...
par(mai = c(0.9,0.9,0.6,0.1))
plot(density(pancreas_vsnrma_matrix[,1]), type = "n", xlab = "log intensity", main = "Density function of log intensity of PDAC cells (GSE53454) \n after normalization", ylim = c(0,0.7))
