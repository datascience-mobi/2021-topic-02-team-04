...
plot(density(diabetes_vsnrma_matrix), 
     type = "n", xlab = "log Intensity", ylim = c(0,0.5), 
     main = "Density function of log Intensity of \n normalized diabetes type 1 data")
...
for (i in 1:23){
  plot(exprs(diabetes_vsnrma)[,i], exprs(diabetes_vsnrma)[,i+1], pch = ".",
       xlab = substr(colnames(diabetes_matrix), 1,10)[i],
       ylab = substr(colnames(diabetes_matrix), 1,10)[i+1])
  abline(0,1,col="red")
