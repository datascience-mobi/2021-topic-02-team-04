...
diabetesvspancreas_fc = log2.fold.change(diabetestreatmentdifferentialgenes, pancreascontroldifferentialgenes) # ratio = pancreas/diabetes
...
plot(CUZD1exprdieabcontr, pch=20,col='grey', main="Models of CUZD1 expression in ß-cell control", xlim=c(0, 100), ylim=c(8, 13))
points(modelprediction, col="red", pch=20)
points(meanprediction, col="blue", pch=20)
points(realvalue, col="black", pch=20)

legend("bottomleft", 
  legend = c("mean predicition", "linear model predicition", "true value"), 
