...
\begin{center}
\LARGE
  TRA expression in the pancreas \\
  \Large
	Analysis of TRA expression in pancreatic cancer cells and $\beta$-cells
	\vspace{0.5cm}
	\hrule 
	\vspace{1cm}
  \large
...
\section*{Abstract}
Cancer induced mutations and cytokine treatment lead to differences in the expression of tissue restricted antigens in pancreatic cells. These differences were used to identify the potential biomarkers for pancreatic ductal adenocarcinoma TSPAN8 and GMNN. Furthermore, genes leading pancreatic cells into proliferation or cell death were identified. Indicators of pancreatic cancer are STT3A and GMNN and a predictor of diabetes is CXCL11.
